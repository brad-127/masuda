...
def start_experiment(**args):
    ...
    with log, tf_sess:
        ...
        #screen = gym.make('res-v0')
        screen = gym.make('resL-v0')
...
class Trainer(object):
    ...
    def train(self,sess):
        ...
        ckpt = tf.train.get_checkpoint_state('./logs/restore_data')
        if ckpt:
...
def add_optimization_params(parser):
    ...
    parser.add_argument('--num_timesteps', type=int, default=int(3.11e4))   #5.001e6     #default 1e8
